...
@section('content')
    <h1 class="h3 mb-3">Tentang Aplikasi</h1>
                        ...
                        <div class="col-12 col-lg-8 col-xxl-12 d-flex">
                            <div class="card flex-fill">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Tentang Aplikasi</h5>
                                </div>
                                        ...
                                        <tbody>
                                            @foreach ($data as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <a href="{{ url('/dashboard/about/edit/' . $row->id) }}"><span class="badge bg-success">Edit <i
                                                                        class="align-middle"
